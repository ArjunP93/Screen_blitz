import { Button,Dialog,DialogBody,DialogFooter,DialogHeader,Tooltip,IconButton,PencilIcon,Input } from '@material-tailwind/react'
import React, { useEffect, useState } from 'react'
import { useSelector } from 'react-redux'
import { addProfilePic, editTheaterProfile, getTheaterProfileInfo } from '../../../api/theaterApi'
...
console.log('theaterProfileInfo',theaterProfileInfo)
    useEffect(()=>{
        ...
        fetchTheater().then((data)=>{
            setTheaterProfileInfo({...data?.theater?._doc,screens:data?.theater?.screens})
    ...
    <div className='mx-auto h-3/4 w-8/12 flex flex-col  rounded-lg shadow-lg'>
        ...
        <div className='mx-auto'>
            <table>
                ...
                <td className='p-4'>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo?.theaterName}</tr>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo?.email}</tr>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo?.mobile}</tr>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo?.screens}</tr>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo.location}</tr>
                    <tr className='p-4 text-lg font-bold'>{theaterProfileInfo?.description}</tr>

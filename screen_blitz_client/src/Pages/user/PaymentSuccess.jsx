...
import { PaymentStatusReturn } from '../../api/userApi'
...
function PaymentSuccess() {
  ...
  async function confirmPayment(){
   ...
   const response =  await PaymentStatusReturn(reqBodyBooking)
   return response
...
<div className="bg-gray-100 h-screen">
      <div className="bg-white p-6  md:mx-auto">
        ...
        <div className="text-center">
            ...
            <p className="text-gray-600 my-2">Your ticket confirmation is sent to registered email</p>
            <p>Enjoy the show!!! Have a great day!  </p>
